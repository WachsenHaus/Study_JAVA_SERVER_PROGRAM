...
<%
	...
	/*
		...
		request scope에 담은 키 값은 응답하기 전까지 사용할 수 있다.
	...
	*/
	...
	/*
		application scope에 "companyName"이라는 키값으로 companyName담기
	...
	*/
	...
	dto.setContent("놀자~");
	/*
		request 영역에 dto라는 키값으로 cafedto type인 dto 담기
	*/
...
<body>
	<h1>EL로 page scope에 저장된 값 추출</<h1></h1>>
